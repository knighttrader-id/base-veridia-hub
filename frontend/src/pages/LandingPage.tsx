...
const stats = [
  { number: '10,000+', label: 'Karya Terdaftar' },
  { number: '5,000+', label: 'Kreator Aktif' },
  { number: '$2.5M+', label: 'Total Royalti' },
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-red-600 bg-clip-text text-transparent mb-2">
                  {stat.number}
                </div>
